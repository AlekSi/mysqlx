...
func (Open_CtxOperation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_a3b4756b056249fa, []int{0, 0}
}
...
func (Open_Condition_Key) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_a3b4756b056249fa, []int{0, 0, 0}
}
...
func (Open_Condition_ConditionOperation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_a3b4756b056249fa, []int{0, 0, 1}
}
...
func (*Open) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_a3b4756b056249fa, []int{0}
}
...
func (*Close) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_a3b4756b056249fa, []int{1}
}
...
func init() { proto.RegisterFile("mysqlx_expect.proto", fileDescriptor_mysqlx_expect_a3b4756b056249fa) }

var fileDescriptor_mysqlx_expect_a3b4756b056249fa = []byte{
