...
func (Find_RowLock) EnumDescriptor() ([]byte, []int) { return fileDescriptorMysqlxCrud, []int{6, 0} }
...
func init() { proto.RegisterFile("mysqlx_crud.proto", fileDescriptorMysqlxCrud) }
